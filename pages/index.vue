        ...
        <el-tab-pane name="2" label="Auto Resposta">
          <el-form>
            <div class="row">
              ...
              <div class="col-md-3">
                <button class="float-left btn-danger btn-sm btn" style="margin-top:40px;" v-if="activeSave" @click="set" type="danger">Submit</button>
                <button class="float-left mt-5 btn-danger btn btn-sm"  v-if="activeUpdate" @click="update" type="danger">Update</button>
              </div>
     ...
     <table class="table table-striped">
        ...
        <draggable v-model="responses" tag="tbody"  @update="moved">
          <tr v-for="item in responses" :key="item.name">
            ...
            <td>
               <button class="btn-danger btn btn-sm" @click="edit(item)" type="danger" size="small"><i class="el-icon-edit"></i></button>
                <!-- <el-popconfirm
  title="Are you sure to delete this?"
>
                <el-button slot="reference" class="btn-danger btn btn-sm" @click="deleteRes(item.id)" type="danger" size="small"><i class="el-icon-delete"></i></el-button>
...
>
             ...
             <td>{{ item.name }}</td>
            <td>{{ item.message }}</td>
            <td><label class="float-left;">{{ item.response }}</label></td>
            <td></td>
          </tr>
        </draggable>
      </table>
        ...
        <el-tab-pane name="4" label="BulkData Import">
          ...
          >
            ...
            <div class="el-upload__text">
              Upload here your file <em>click to load</em>
            </div>
            <div slot="tip" class="el-upload__tip">
              can upload CSV and TXT <b>2GB</b>. you can download
              the template from
        ...
        <el-tab-pane name="1" show="false" label="Mercury API Config">
          <div class="row">
            ...
            <div class="col-md-3">
                ...
                <el-input v-model="user.apitoken"></el-input>
            </div>

            <div class="col-md-2">
              <button class=" btn btn-danger btn-sm float-left" style="margin-top:35px;" @click="updateUser" type="danger">Update</button>
            </div>
